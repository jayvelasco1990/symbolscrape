...
const TABS = [
  { key: "megacap",  label: "Mega Cap",  description: "Market cap > $200B · Low beta" },
  { key: "largecap", label: "Large Cap", description: "Market cap $10B–$200B · USA · Low beta" },
      ...
      <div className="bg-white dark:bg-black border-b border-zinc-200 dark:border-zinc-800 px-6 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xs text-zinc-400 dark:text-zinc-500 mt-3">
            {activeTabData.description}{dividend ? " · Dividend" : ""}{rsi ? " · RSI < 50" : ""}
          </p>
        </div>
      </div>
